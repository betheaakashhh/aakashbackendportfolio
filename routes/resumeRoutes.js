...
// POST - Add extracurricular activity
router.post('/extracurricular', adminAuth, async (req, res) => {
  try {
    ...
    res.status(201).json({
      success: true,
      message: 'Extracurricular activity added',
      data: resume.extracurricular
    });
  } catch (error) {
    console.error('Error adding extracurricular:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to add extracurricular activity',
      error: error.message
    });
  }
});

// PUT - Update extracurricular activity
router.put('/extracurricular/:id', adminAuth, async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      message: 'Extracurricular activity updated',
      data: activity
    });
  } catch (error) {
...
// DELETE - Remove extracurricular activity
...
// PATCH - Toggle resume publish status
